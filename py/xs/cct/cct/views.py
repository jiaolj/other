...
def servicegroup(req,num=1):
    ...
    app=1
    sgp=sgroup[int(num)]
    return render_to_response('service/group.html',{'seoTitle':seoTitle,'index':index,'app':app,'sgp':sgp})
def serviceusa(req):
    seoTitle='赴美试管医疗_'+pubTitle
    index=3
    app=2
    return render_to_response('service/usa.html',{'seoTitle':seoTitle,'index':index,'app':app})
def servicetha(req):
    seoTitle='赴泰试管医疗_'+pubTitle
    index=3
    app=2
    return render_to_response('service/tha.html',{'seoTitle':seoTitle,'index':index,'app':app})
def servicepcs(req):
    seoTitle='服务流程_'+pubTitle
    index=3
    app=3
    return render_to_response('service/pcs.html',{'seoTitle':seoTitle,'index':index,'app':app})
