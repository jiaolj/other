...
$(function(){
	...
	var HTML = '\
	  <form action="#" id="gamelist" novalidate>\
	    <label>\
	      <em>Get notified when I release my next game!</em>\
	      <input type="email" name="" value="" placeholder="Enter your email here" maxlength="64">\
	    </label>\
